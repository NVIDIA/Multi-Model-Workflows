...
registry="nvcr.io"
repository="nvstaging/tao/tao_multi_model_workflows"
...
if [ $BUILD_DOCKER = "1" ]; then
    ...
    DOCKER_BUILDKIT=1 docker build --pull -f $REPO_TOP/docker/Dockerfile.build -t $registry/$repository:$local_tag $NO_CACHE \
